...
/**
 * Simple snowflake ID generator that produces 64-bit numeric IDs encoded as
 * decimal strings.
 * This implementation is deterministic and not cluster-coordinated; set
 * workerId appropriately.
 */
